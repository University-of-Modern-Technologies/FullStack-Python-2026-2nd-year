"""Pydantic-схеми для створення, оновлення та видачі todo."""
...
class TodoUpdateSchema(BaseModel):
    """Схема часткового оновлення текстових полів todo."""
...
class TodoUpdateStatusSchema(BaseModel):
    """Схема зміни статусу виконання todo."""
    completed: bool


class TodoResponse(BaseModel):
    """Схема відповіді API для todo."""
    id: int = 1
    user_id: int
    title: str
